...
test.spec('metalsmith-taxonomy', function () {
    ...
    test('Should support super-simple parameter-less instantiation', function (done) {
      instance
        ...
        .process(function (err) {
          ...
          var validity = !(err && err.prototype !== Error)
      ...
      instance
        ...
        .process(function (err, files) {
          ...
          var validity = !(err && err.prototype !== Error)
            ...
            && files.hasOwnProperty('taxonomies/blog/category/a.html')
            && !files.hasOwnProperty('taxonomies/category/b.html');
  ...
  test.spec('Single taxonomy', function () {
    ...
    test('taxonomy termset property value supports nested-key file-metadata lookup', function () {
      var validity = taxonomies.keywords && Object.keys(taxonomies.keywords).length === 2 &&
        taxonomies.keywords.one && taxonomies.keywords.one.length === 1 &&
        taxonomies.keywords.two && taxonomies.keywords.two.length === 1;

      test(validity).equals(true);
    });

    test('taxonomy termset property value supports function value', function () {
      var validity = taxonomies.categoryAlias && Object.keys(taxonomies.categoryAlias).length === 2 &&
        taxonomies.categoryAlias.none && taxonomies.categoryAlias.none.length === 1 &&
        taxonomies.categoryAlias.a && taxonomies.categoryAlias.a.length === 1;
  ...
  test.spec('Multiple taxonomies', function () {
    ...
    test('taxonomy termset property value supports nested-key file-metadata lookup', function () {
      var validity = blog.keywords && Object.keys(blog.keywords).length === 2 &&
        blog.keywords.one && blog.keywords.one.length === 1 &&
        blog.keywords.two && blog.keywords.two.length === 1;

      test(validity).equals(true);
    });

    test('taxonomy termset property value supports function value', function () {
      var validity = blog.categoryAlias && Object.keys(blog.categoryAlias).length === 2 &&
        blog.categoryAlias.none && blog.categoryAlias.none.length === 1 &&
        blog.categoryAlias.a && blog.categoryAlias.a.length === 1;
